  ...
  stages {
   ...
   // }
    stage ('DEV Deploy') {
      ...
      deploy adapters: [tomcat9(credentialsId: 'b748541d-6d0e-4ff7-b89b-6f04e6310434', path: '', url: 'http://ec2-3-138-141-177.us-east-2.compute.amazonaws.com:8080')], contextPath: null, war: '**/*.war'
      }
    }
